...
/**
 * API tests for LegalDocApi
 */
@Disabled
public class LegalDocApiTest {

    private static LegalDocApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new LegalDocApi(apiClient);
    }
    ...
    public void createDocumentTest() throws ApiException {
        ...
        String content = null;
        LocalDate date = null;
        api.createDocument(name, content, date)
                .execute();
    ...
    public void getByNameTest() throws ApiException {
        String name = null;
        LegalDoc response = api.getByName(name)
                .execute();
        // TODO: test validations
    }
