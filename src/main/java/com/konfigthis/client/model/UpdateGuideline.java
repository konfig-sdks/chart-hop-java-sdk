...
public class UpdateGuideline {
 ...
 public enum BasisTypeEnum {
  ...
  public UpdateGuideline label(String label) {
  ...
  **/
  ...
  @ApiModelProperty(example = "Merit Guideline", value = "guideline name")
  ...
  public UpdateGuideline budgetPoolId(String budgetPoolId) {
  ...
  **/
  ...
  public UpdateGuideline participantsExpr(String participantsExpr) {
  ...
  **/
  ...
  public UpdateGuideline appliedField(String appliedField) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "'base' or 'grantShares'", value = "the field the guideline applies to")
  ...
  public UpdateGuideline sourceField(String sourceField) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "'base' or 'grantShares'", value = "the field the guideline is calculated from")
  ...
  public UpdateGuideline calculationType(CalculationTypeEnum calculationType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "TARGET", value = "how does the guideline calculate the target value? e.g. is there a range (min/max) or only a target")
  ...
  public UpdateGuideline flagMode(FlagModeEnum flagMode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "NONE", value = "how does the guideline indicate deviations from the target amount")
  ...
  public UpdateGuideline flagDeviationThreshold(Double flagDeviationThreshold) {
  ...
  public UpdateGuideline flagDeviationThreshold(Integer flagDeviationThreshold) {
  ...
  **/
  ...
  public UpdateGuideline enablePopulateValue(Boolean enablePopulateValue) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "whether or not the target values from the guidelines are pre-populated in the given columns")
  ...
  public UpdateGuideline basisType(BasisTypeEnum basisType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "CUSTOM", value = "how an individual guideline value itself is calculated, e.g. percentage of the appliedField, fixed amount, or custom CQL")
  ...
  public UpdateGuideline basisExpr(String basisExpr) {
  ...
  **/
  ...
  public UpdateGuideline basisFieldMatrix(BasisFieldMatrix basisFieldMatrix) {
  ...
  **/
  ...
  public UpdateGuideline fixedAmountRange(MoneyRange fixedAmountRange) {
  ...
  **/
  ...
  public UpdateGuideline fixedValueRange(ValueRange fixedValueRange) {
  ...
  **/
   ...
   * @return the UpdateGuideline instance itself
   */
  public UpdateGuideline putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateGuideline updateGuideline = (UpdateGuideline) o;
    return Objects.equals(this.label, updateGuideline.label) &&
        Objects.equals(this.budgetPoolId, updateGuideline.budgetPoolId) &&
        Objects.equals(this.participantsExpr, updateGuideline.participantsExpr) &&
        Objects.equals(this.appliedField, updateGuideline.appliedField) &&
        Objects.equals(this.sourceField, updateGuideline.sourceField) &&
        Objects.equals(this.calculationType, updateGuideline.calculationType) &&
        Objects.equals(this.flagMode, updateGuideline.flagMode) &&
        Objects.equals(this.flagDeviationThreshold, updateGuideline.flagDeviationThreshold) &&
        Objects.equals(this.enablePopulateValue, updateGuideline.enablePopulateValue) &&
        Objects.equals(this.basisType, updateGuideline.basisType) &&
        Objects.equals(this.basisExpr, updateGuideline.basisExpr) &&
        Objects.equals(this.basisFieldMatrix, updateGuideline.basisFieldMatrix) &&
        Objects.equals(this.fixedAmountRange, updateGuideline.fixedAmountRange) &&
        Objects.equals(this.fixedValueRange, updateGuideline.fixedValueRange)&&
        Objects.equals(this.additionalProperties, updateGuideline.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(label, budgetPoolId, participantsExpr, appliedField, sourceField, calculationType, flagMode, flagDeviationThreshold, enablePopulateValue, basisType, basisExpr, basisFieldMatrix, fixedAmountRange, fixedValueRange, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateGuideline {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UpdateGuideline
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateGuideline.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateGuideline is not found in the empty JSON string", UpdateGuideline.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("flagMode") != null && !jsonObj.get("flagMode").isJsonNull()) && !jsonObj.get("flagMode").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateGuideline.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateGuideline' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateGuideline> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateGuideline.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateGuideline>() {
           @Override
           public void write(JsonWriter out, UpdateGuideline value) throws IOException {
           ...
           @Override
           public UpdateGuideline read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UpdateGuideline instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UpdateGuideline given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UpdateGuideline
  * @throws IOException if the JSON string is invalid with respect to UpdateGuideline
  */
  public static UpdateGuideline fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateGuideline.class);
  }

 /**
  * Convert an instance of UpdateGuideline to an JSON string
  *
  * @return JSON string
  */
