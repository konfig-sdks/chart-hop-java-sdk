...
public class ReportFilter {
  ...
  public ReportFilter label(String label) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "human-readable label for the filter")
  ...
  public ReportFilter filter(String filter) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "filter expression")
   ...
   * @return the ReportFilter instance itself
   */
  public ReportFilter putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.label, reportFilter.label) &&
        Objects.equals(this.filter, reportFilter.filter)&&
        Objects.equals(this.additionalProperties, reportFilter.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(label, filter, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReportFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ReportFilter>() {
           ...
           public ReportFilter read(JsonReader in) throws IOException {
             ...
             ReportFilter instance = thisAdapter.fromJsonTree(jsonObj);
