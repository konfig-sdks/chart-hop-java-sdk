...
public class AccessTokenResponse {
  ...
  **/
  ...
  @ApiModelProperty(example = "2YotnFZFEjr1zCsicMWsdv", required = true, value = "access token value")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "86400", required = true, value = "expiration time of token, in seconds")
  ...
  **/
  ...
  @ApiModelProperty(example = "tGzv3JOkF0XG5Qx2TlKWIA", value = "refresh token value")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "admin", value = "scope of the access token")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessToken, tokenType, expiresIn, refreshToken, scope, additionalProperties);
  }
