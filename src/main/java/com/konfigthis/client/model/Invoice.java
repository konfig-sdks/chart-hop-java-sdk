...
public class Invoice {
  ...
  **/
  ...
  @ApiModelProperty(example = "F38A6C8-0010", required = true, value = "a unique identifying string for invoices")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "1002.31", required = true, value = "current final amount due for the invoices")
  ...
  **/
  ...
  @ApiModelProperty(example = "https://pay.stripe.com/invoice/invst_Nv8DFERQvTsBJqnZ4z19cGZBU1", value = "URL for the hosted invoice page, which allows customers to view and pay an invoice")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "https://pay.stripe.com/invoice/invst_wNK0BvV4iUOWOn5mzLT1ybQ2LC/pdf", value = "the link to download the PDF for the invoice")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "PAID", required = true, value = "one of PAID, UNPAID, or VOID")
  ...
  public Invoice createAt(String createAt) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "2019-07-27T20:56:10Z", required = true, value = "created timestamp")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(number, amount, hostedInvoiceUrl, invoicePdf, status, createAt, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("hostedInvoiceUrl");
    openapiFields.add("invoicePdf");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if ((jsonObj.get("hostedInvoiceUrl") != null && !jsonObj.get("hostedInvoiceUrl").isJsonNull()) && !jsonObj.get("hostedInvoiceUrl").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `hostedInvoiceUrl` to be a primitive type in the JSON string but got `%s`", jsonObj.get("hostedInvoiceUrl").toString()));
      }
      if ((jsonObj.get("invoicePdf") != null && !jsonObj.get("invoicePdf").isJsonNull()) && !jsonObj.get("invoicePdf").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `invoicePdf` to be a primitive type in the JSON string but got `%s`", jsonObj.get("invoicePdf").toString()));
      }
