...
public class UpdateTable {
 ...
 public enum SensitiveEnum {
  ...
  public UpdateTable name(String name) {
  ...
  **/
  ...
  @ApiModelProperty(example = "budget-data", value = "name of table")
  ...
  public UpdateTable label(String label) {
  ...
  **/
  ...
  public UpdateTable labelColumnId(String labelColumnId) {
  ...
  **/
  ...
  public UpdateTable effectiveDated(Boolean effectiveDated) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "whether or not the table is time tracked with effective dates (allows time travel or not). If false, then the values set in the table will be the same across all dates.")
  ...
  public UpdateTable sensitive(SensitiveEnum sensitive) {
  ...
  **/
  ...
  public UpdateTable shareAccess(List<ShareAccess> shareAccess) {
  ...
  public UpdateTable addShareAccessItem(ShareAccess shareAccessItem) {
  ...
  **/
   ...
   * @return the UpdateTable instance itself
   */
  public UpdateTable putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateTable updateTable = (UpdateTable) o;
    return Objects.equals(this.name, updateTable.name) &&
        Objects.equals(this.label, updateTable.label) &&
        Objects.equals(this.labelColumnId, updateTable.labelColumnId) &&
        Objects.equals(this.effectiveDated, updateTable.effectiveDated) &&
        Objects.equals(this.sensitive, updateTable.sensitive) &&
        Objects.equals(this.shareAccess, updateTable.shareAccess)&&
        Objects.equals(this.additionalProperties, updateTable.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, label, labelColumnId, effectiveDated, sensitive, shareAccess, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateTable {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UpdateTable
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateTable.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateTable is not found in the empty JSON string", UpdateTable.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateTable.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateTable' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateTable> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateTable.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateTable>() {
           @Override
           public void write(JsonWriter out, UpdateTable value) throws IOException {
           ...
           @Override
           public UpdateTable read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UpdateTable instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UpdateTable given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UpdateTable
  * @throws IOException if the JSON string is invalid with respect to UpdateTable
  */
  public static UpdateTable fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateTable.class);
  }

 /**
  * Convert an instance of UpdateTable to an JSON string
  *
  * @return JSON string
  */
