...
public class CreateCompBand {
  ...
  public CreateCompBand() {
  }

  public CreateCompBand label(String label) {
  ...
  **/
  ...
  public CreateCompBand color(String color) {
  ...
  **/
  ...
  public CreateCompBand baseCompMax(Money baseCompMax) {
  ...
  **/
  ...
  public CreateCompBand baseCompMid(Money baseCompMid) {
  ...
  **/
  ...
  public CreateCompBand baseCompMin(Money baseCompMin) {
  ...
  **/
  ...
  public CreateCompBand baseSpread(Double baseSpread) {
  ...
  public CreateCompBand baseSpread(Integer baseSpread) {
  ...
  **/
  ...
  public CreateCompBand baseInterval(EnumValue baseInterval) {
  ...
  **/
  ...
  public CreateCompBand baseTargetPay(Money baseTargetPay) {
  ...
  **/
  ...
  public CreateCompBand baseTargetPayPercentile(Double baseTargetPayPercentile) {
  ...
  public CreateCompBand baseTargetPayPercentile(Integer baseTargetPayPercentile) {
  ...
  **/
  ...
  public CreateCompBand equityTargetShares(Double equityTargetShares) {
  ...
  public CreateCompBand equityTargetShares(Integer equityTargetShares) {
  ...
  **/
  ...
  public CreateCompBand equityTargetPercentOfBase(Double equityTargetPercentOfBase) {
  ...
  public CreateCompBand equityTargetPercentOfBase(Integer equityTargetPercentOfBase) {
  ...
  **/
  ...
  public CreateCompBand equityTargetValue(Double equityTargetValue) {
  ...
  public CreateCompBand equityTargetValue(Integer equityTargetValue) {
  ...
  **/
  ...
  public CreateCompBand variableValue(Money variableValue) {
  ...
  **/
  ...
  public CreateCompBand variablePercentOfBase(Double variablePercentOfBase) {
  ...
  public CreateCompBand variablePercentOfBase(Integer variablePercentOfBase) {
  ...
  **/
  ...
  public CreateCompBand jobTierOneField(String jobTierOneField) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "first job tier associated with the comp band")

  public String getJobTierOneField() {
    return jobTierOneField;
  }


  public void setJobTierOneField(String jobTierOneField) {
  ...
  public CreateCompBand jobTierTwoField(String jobTierTwoField) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "second job tier associated with the comp band")

  public String getJobTierTwoField() {
    return jobTierTwoField;
  }


  public void setJobTierTwoField(String jobTierTwoField) {
  ...
  public CreateCompBand jobTierThreeField(String jobTierThreeField) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "third job tier associated with the comp band")

  public String getJobTierThreeField() {
    return jobTierThreeField;
  }


  public void setJobTierThreeField(String jobTierThreeField) {
  ...
  public CreateCompBand jobLevel(String jobLevel) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "job level associated with the comp band")
   ...
   * @return the CreateCompBand instance itself
   */
  public CreateCompBand putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreateCompBand createCompBand = (CreateCompBand) o;
    return Objects.equals(this.label, createCompBand.label) &&
        Objects.equals(this.color, createCompBand.color) &&
        Objects.equals(this.baseCompMax, createCompBand.baseCompMax) &&
        Objects.equals(this.baseCompMid, createCompBand.baseCompMid) &&
        Objects.equals(this.baseCompMin, createCompBand.baseCompMin) &&
        Objects.equals(this.baseSpread, createCompBand.baseSpread) &&
        Objects.equals(this.baseInterval, createCompBand.baseInterval) &&
        Objects.equals(this.baseTargetPay, createCompBand.baseTargetPay) &&
        Objects.equals(this.baseTargetPayPercentile, createCompBand.baseTargetPayPercentile) &&
        Objects.equals(this.equityTargetShares, createCompBand.equityTargetShares) &&
        Objects.equals(this.equityTargetPercentOfBase, createCompBand.equityTargetPercentOfBase) &&
        Objects.equals(this.equityTargetValue, createCompBand.equityTargetValue) &&
        Objects.equals(this.variableValue, createCompBand.variableValue) &&
        Objects.equals(this.variablePercentOfBase, createCompBand.variablePercentOfBase) &&
        Objects.equals(this.jobTierOneField, createCompBand.jobTierOneField) &&
        Objects.equals(this.jobTierTwoField, createCompBand.jobTierTwoField) &&
        Objects.equals(this.jobTierThreeField, createCompBand.jobTierThreeField) &&
        Objects.equals(this.jobLevel, createCompBand.jobLevel)&&
        Objects.equals(this.additionalProperties, createCompBand.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateCompBand {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("jobLevel");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateCompBand
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateCompBand.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateCompBand is not found in the empty JSON string", CreateCompBand.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateCompBand.openapiRequiredFields) {
      ...
      if ((jsonObj.get("jobTierOneField") != null && !jsonObj.get("jobTierOneField").isJsonNull()) && !jsonObj.get("jobTierOneField").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `jobTierOneField` to be a primitive type in the JSON string but got `%s`", jsonObj.get("jobTierOneField").toString()));
      }
      if ((jsonObj.get("jobTierTwoField") != null && !jsonObj.get("jobTierTwoField").isJsonNull()) && !jsonObj.get("jobTierTwoField").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `jobTierTwoField` to be a primitive type in the JSON string but got `%s`", jsonObj.get("jobTierTwoField").toString()));
      }
      if ((jsonObj.get("jobTierThreeField") != null && !jsonObj.get("jobTierThreeField").isJsonNull()) && !jsonObj.get("jobTierThreeField").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `jobTierThreeField` to be a primitive type in the JSON string but got `%s`", jsonObj.get("jobTierThreeField").toString()));
      }
      if (!jsonObj.get("jobLevel").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateCompBand.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateCompBand' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateCompBand> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateCompBand.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateCompBand>() {
           @Override
           public void write(JsonWriter out, CreateCompBand value) throws IOException {
           ...
           @Override
           public CreateCompBand read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreateCompBand instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreateCompBand given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateCompBand
  * @throws IOException if the JSON string is invalid with respect to CreateCompBand
  */
  public static CreateCompBand fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateCompBand.class);
  }

 /**
  * Convert an instance of CreateCompBand to an JSON string
  *
  * @return JSON string
  */
