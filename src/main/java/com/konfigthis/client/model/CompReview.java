...
public class CompReview {
 ...
 public enum StatusEnum {
  ...
  public CompReview id(String id) {
  ...
  **/
  ...
  public CompReview orgId(String orgId) {
  ...
  **/
  ...
  public CompReview label(String label) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Comp review H2 2022", required = true, value = "human-readable label of goal")
  ...
  public CompReview config(CompReviewConfig config) {
  ...
  **/
  ...
  public CompReview status(StatusEnum status) {
  ...
  **/
  ...
  public CompReview shareAccess(List<ShareAccess> shareAccess) {
  ...
  public CompReview addShareAccessItem(ShareAccess shareAccessItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "users who have been granted access to this comp review")
  ...
  public CompReview reviewerCount(Integer reviewerCount) {
  ...
  **/
  ...
  public CompReview submittedCount(Integer submittedCount) {
  ...
  **/
  ...
  public CompReview createId(String createId) {
  ...
  **/
  ...
  public CompReview createAt(String createAt) {
  ...
  **/
  ...
  public CompReview updateId(String updateId) {
  ...
  **/
  ...
  public CompReview updateAt(String updateAt) {
  ...
  **/
  ...
  public CompReview deleteId(String deleteId) {
  ...
  **/
  ...
  public CompReview deleteAt(String deleteAt) {
  ...
  **/
   ...
   * @return the CompReview instance itself
   */
  public CompReview putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CompReview compReview = (CompReview) o;
    return Objects.equals(this.id, compReview.id) &&
        Objects.equals(this.orgId, compReview.orgId) &&
        Objects.equals(this.label, compReview.label) &&
        Objects.equals(this.config, compReview.config) &&
        Objects.equals(this.status, compReview.status) &&
        Objects.equals(this.shareAccess, compReview.shareAccess) &&
        Objects.equals(this.reviewerCount, compReview.reviewerCount) &&
        Objects.equals(this.submittedCount, compReview.submittedCount) &&
        Objects.equals(this.createId, compReview.createId) &&
        Objects.equals(this.createAt, compReview.createAt) &&
        Objects.equals(this.updateId, compReview.updateId) &&
        Objects.equals(this.updateAt, compReview.updateAt) &&
        Objects.equals(this.deleteId, compReview.deleteId) &&
        Objects.equals(this.deleteAt, compReview.deleteAt)&&
        Objects.equals(this.additionalProperties, compReview.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, orgId, label, config, status, shareAccess, reviewerCount, submittedCount, createId, createAt, updateId, updateAt, deleteId, deleteAt, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CompReview {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CompReview
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CompReview.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CompReview is not found in the empty JSON string", CompReview.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CompReview.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CompReview.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CompReview' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CompReview> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CompReview.class));

       return (TypeAdapter<T>) new TypeAdapter<CompReview>() {
           @Override
           public void write(JsonWriter out, CompReview value) throws IOException {
           ...
           @Override
           public CompReview read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CompReview instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CompReview given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CompReview
  * @throws IOException if the JSON string is invalid with respect to CompReview
  */
  public static CompReview fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CompReview.class);
  }

 /**
  * Convert an instance of CompReview to an JSON string
  *
  * @return JSON string
  */
