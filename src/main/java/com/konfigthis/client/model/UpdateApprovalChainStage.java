...
public class UpdateApprovalChainStage {
 ...
 public enum StatusEnum {
  ...
  public UpdateApprovalChainStage() {
  }

  public UpdateApprovalChainStage inclusionExpression(String inclusionExpression) {
  ...
  **/
  ...
  public UpdateApprovalChainStage inclusionBehavior(InclusionBehaviorEnum inclusionBehavior) {
  ...
  **/
  ...
  public UpdateApprovalChainStage expandExpression(String expandExpression) {
  ...
  **/
  ...
  public UpdateApprovalChainStage rejectBehavior(RejectBehaviorEnum rejectBehavior) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "determines which stage becomes active when a rejection event happens")
  ...
  public UpdateApprovalChainStage status(StatusEnum status) {
  ...
  **/
  ...
  public UpdateApprovalChainStage approvalCommentRequired(Boolean approvalCommentRequired) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "requires a comment on an approval event")
  ...
  public UpdateApprovalChainStage rejectionCommentRequired(Boolean rejectionCommentRequired) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "requires a comment on an rejection event")
  ...
  public UpdateApprovalChainStage order(Integer order) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "order of stage in approval chain")
  ...
  public UpdateApprovalChainStage groups(List<ApprovalGroup> groups) {
  ...
  public UpdateApprovalChainStage addGroupsItem(ApprovalGroup groupsItem) {
    if (this.groups == null) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "list of groups that are involved in this approval stage")
   ...
   * @return the UpdateApprovalChainStage instance itself
   */
  public UpdateApprovalChainStage putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateApprovalChainStage updateApprovalChainStage = (UpdateApprovalChainStage) o;
    return Objects.equals(this.inclusionExpression, updateApprovalChainStage.inclusionExpression) &&
        Objects.equals(this.inclusionBehavior, updateApprovalChainStage.inclusionBehavior) &&
        Objects.equals(this.expandExpression, updateApprovalChainStage.expandExpression) &&
        Objects.equals(this.rejectBehavior, updateApprovalChainStage.rejectBehavior) &&
        Objects.equals(this.status, updateApprovalChainStage.status) &&
        Objects.equals(this.approvalCommentRequired, updateApprovalChainStage.approvalCommentRequired) &&
        Objects.equals(this.rejectionCommentRequired, updateApprovalChainStage.rejectionCommentRequired) &&
        Objects.equals(this.order, updateApprovalChainStage.order) &&
        Objects.equals(this.groups, updateApprovalChainStage.groups)&&
        Objects.equals(this.additionalProperties, updateApprovalChainStage.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateApprovalChainStage {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UpdateApprovalChainStage
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateApprovalChainStage.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateApprovalChainStage is not found in the empty JSON string", UpdateApprovalChainStage.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("rejectBehavior") != null && !jsonObj.get("rejectBehavior").isJsonNull()) && !jsonObj.get("rejectBehavior").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateApprovalChainStage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateApprovalChainStage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateApprovalChainStage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateApprovalChainStage.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateApprovalChainStage>() {
           @Override
           public void write(JsonWriter out, UpdateApprovalChainStage value) throws IOException {
           ...
           @Override
           public UpdateApprovalChainStage read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UpdateApprovalChainStage instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UpdateApprovalChainStage given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UpdateApprovalChainStage
  * @throws IOException if the JSON string is invalid with respect to UpdateApprovalChainStage
  */
  public static UpdateApprovalChainStage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateApprovalChainStage.class);
  }

 /**
  * Convert an instance of UpdateApprovalChainStage to an JSON string
  *
  * @return JSON string
  */
