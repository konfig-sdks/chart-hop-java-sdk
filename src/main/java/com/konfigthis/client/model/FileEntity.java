...
public class FileEntity {
 ...
 public enum SensitiveEnum {
  ...
  public FileEntity id(String id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "588f7ee98f138b19220041a7", required = true, value = "globally unique id of file")
  ...
  public FileEntity orgId(String orgId) {
  ...
  **/
  ...
  public FileEntity entityId(String entityId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "588f7ee98f138b19220041a7", value = "entity id that the file is attached to")
  ...
  public FileEntity entityType(EntityTypeEnum entityType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "588f7ee98f138b19220041a7", value = "entity type (should only be PERSON or USER)")
  ...
  public FileEntity field(String field) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "offerLetter", value = "field name that the file uses, if the file is tied to a field")
  ...
  public FileEntity sensitive(SensitiveEnum sensitive) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "PERSONAL", value = "level of sensitivity of the file, if the file is not tied to a field")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Offer Letter - Bob Smith.pdf", required = true, value = "customer facing filename of file")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "BOB-SMITH.pdf", required = true, value = "original filename of file")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "application/pdf", required = true, value = "mime type of file")
  ...
  public FileEntity ext(String ext) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "pdf", required = true, value = "extension of file")
  ...
  public FileEntity bytes(Long bytes) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "102342", required = true, value = "size of file in bytes")
  ...
  public FileEntity createId(String createId) {
  ...
  **/
  ...
  public FileEntity createAt(String createAt) {
  ...
  **/
  ...
  public FileEntity deleteId(String deleteId) {
  ...
  **/
  ...
  public FileEntity deleteAt(String deleteAt) {
  ...
  **/
   ...
   * @return the FileEntity instance itself
   */
  public FileEntity putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, fileEntity.id) &&
        Objects.equals(this.orgId, fileEntity.orgId) &&
        Objects.equals(this.entityId, fileEntity.entityId) &&
        Objects.equals(this.entityType, fileEntity.entityType) &&
        Objects.equals(this.field, fileEntity.field) &&
        Objects.equals(this.sensitive, fileEntity.sensitive) &&
        Objects.equals(this.filename, fileEntity.filename) &&
        Objects.equals(this.originalFilename, fileEntity.originalFilename) &&
        Objects.equals(this.type, fileEntity.type) &&
        Objects.equals(this.ext, fileEntity.ext) &&
        Objects.equals(this.bytes, fileEntity.bytes) &&
        Objects.equals(this.createId, fileEntity.createId) &&
        Objects.equals(this.createAt, fileEntity.createAt) &&
        Objects.equals(this.deleteId, fileEntity.deleteId) &&
        Objects.equals(this.deleteAt, fileEntity.deleteAt)&&
        Objects.equals(this.additionalProperties, fileEntity.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, orgId, entityId, entityType, field, sensitive, filename, originalFilename, type, ext, bytes, createId, createAt, deleteId, deleteAt, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FileEntity
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FileEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : FileEntity.openapiRequiredFields) {
      ...
      if (!jsonObj.get("ext").isJsonPrimitive()) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FileEntity>() {
           ...
           public FileEntity read(JsonReader in) throws IOException {
             ...
             FileEntity instance = thisAdapter.fromJsonTree(jsonObj);
