...
public class CreateProfileTab {
 ...
 public enum StatusEnum {
  ...
  public CreateProfileTab label(String label) {
  ...
  **/
  ...
  public CreateProfileTab blocks(List<Block> blocks) {
  ...
  public CreateProfileTab addBlocksItem(Block blocksItem) {
  ...
  **/
  ...
  public CreateProfileTab status(StatusEnum status) {
  ...
  **/
  ...
  public CreateProfileTab targetFilter(String targetFilter) {
  ...
  **/
  ...
  public CreateProfileTab readFilter(String readFilter) {
  ...
  **/
  ...
  public CreateProfileTab sort(Integer sort) {
  ...
  **/
   ...
   * @return the CreateProfileTab instance itself
   */
  public CreateProfileTab putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreateProfileTab createProfileTab = (CreateProfileTab) o;
    return Objects.equals(this.label, createProfileTab.label) &&
        Objects.equals(this.blocks, createProfileTab.blocks) &&
        Objects.equals(this.status, createProfileTab.status) &&
        Objects.equals(this.targetFilter, createProfileTab.targetFilter) &&
        Objects.equals(this.readFilter, createProfileTab.readFilter) &&
        Objects.equals(this.sort, createProfileTab.sort)&&
        Objects.equals(this.additionalProperties, createProfileTab.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateProfileTab {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateProfileTab
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateProfileTab.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateProfileTab is not found in the empty JSON string", CreateProfileTab.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateProfileTab.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateProfileTab.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateProfileTab' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateProfileTab> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateProfileTab.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateProfileTab>() {
           @Override
           public void write(JsonWriter out, CreateProfileTab value) throws IOException {
           ...
           @Override
           public CreateProfileTab read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreateProfileTab instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreateProfileTab given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateProfileTab
  * @throws IOException if the JSON string is invalid with respect to CreateProfileTab
  */
  public static CreateProfileTab fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateProfileTab.class);
  }

 /**
  * Convert an instance of CreateProfileTab to an JSON string
  *
  * @return JSON string
  */
