...
public class PartialAction {
  ...
  private List<ActionStep> steps = null;
 ...
 public enum CategoryEnum {
  ...
  public PartialAction tags(List<String> tags) {
  ...
  public PartialAction addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public PartialAction description(String description) {
  ...
  **/
  ...
  public PartialAction id(String id) {
  ...
  **/
  ...
  public PartialAction orgId(String orgId) {
  ...
  **/
  ...
  public PartialAction event(String event) {
  ...
  **/
  ...
  public PartialAction cronSchedule(String cronSchedule) {
  ...
  **/
  ...
  public PartialAction filter(String filter) {
  ...
  **/
  ...
  public PartialAction steps(List<ActionStep> steps) {
  ...
  public PartialAction addStepsItem(ActionStep stepsItem) {
    if (this.steps == null) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "list of steps to run when matching the event, schedule, and filter")
  ...
  public PartialAction status(StatusEnum status) {
  ...
  **/
  ...
  public PartialAction runUserId(String runUserId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "588f7ee98f138b19220041a7", value = "the user to run the action as - normally the same as the user who created the action")
  ...
  public PartialAction sensitive(Boolean sensitive) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "whether to run with access to sensitive events or not")
  ...
  public PartialAction category(CategoryEnum category) {
  ...
  **/
  ...
  public PartialAction createId(String createId) {
  ...
  **/
  ...
  public PartialAction createAt(String createAt) {
  ...
  **/
  ...
  public PartialAction updateId(String updateId) {
  ...
  **/
  ...
  public PartialAction updateAt(String updateAt) {
  ...
  **/
  ...
  public PartialAction deleteId(String deleteId) {
  ...
  **/
  ...
  public PartialAction deleteAt(String deleteAt) {
  ...
  **/
   ...
   * @return the PartialAction instance itself
   */
  public PartialAction putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PartialAction partialAction = (PartialAction) o;
    return Objects.equals(this.tags, partialAction.tags) &&
        Objects.equals(this.description, partialAction.description) &&
        Objects.equals(this.id, partialAction.id) &&
        Objects.equals(this.orgId, partialAction.orgId) &&
        Objects.equals(this.event, partialAction.event) &&
        Objects.equals(this.cronSchedule, partialAction.cronSchedule) &&
        Objects.equals(this.filter, partialAction.filter) &&
        Objects.equals(this.steps, partialAction.steps) &&
        Objects.equals(this.status, partialAction.status) &&
        Objects.equals(this.runUserId, partialAction.runUserId) &&
        Objects.equals(this.sensitive, partialAction.sensitive) &&
        Objects.equals(this.category, partialAction.category) &&
        Objects.equals(this.createId, partialAction.createId) &&
        Objects.equals(this.createAt, partialAction.createAt) &&
        Objects.equals(this.updateId, partialAction.updateId) &&
        Objects.equals(this.updateAt, partialAction.updateAt) &&
        Objects.equals(this.deleteId, partialAction.deleteId) &&
        Objects.equals(this.deleteAt, partialAction.deleteAt)&&
        Objects.equals(this.additionalProperties, partialAction.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PartialAction
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PartialAction.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PartialAction is not found in the empty JSON string", PartialAction.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("runUserId") != null && !jsonObj.get("runUserId").isJsonNull()) && !jsonObj.get("runUserId").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PartialAction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PartialAction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PartialAction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PartialAction.class));

       return (TypeAdapter<T>) new TypeAdapter<PartialAction>() {
           @Override
           public void write(JsonWriter out, PartialAction value) throws IOException {
           ...
           @Override
           public PartialAction read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PartialAction instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PartialAction given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PartialAction
  * @throws IOException if the JSON string is invalid with respect to PartialAction
  */
  public static PartialAction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PartialAction.class);
  }

 /**
  * Convert an instance of PartialAction to an JSON string
  *
  * @return JSON string
  */
