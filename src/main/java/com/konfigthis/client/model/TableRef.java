...
public class TableRef {
  ...
  public TableRef tableId(String tableId) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "the table id this field references")
  ...
  public TableRef tableName(String tableName) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "the table name this field references")
   ...
   * @return the TableRef instance itself
   */
  public TableRef putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tableId, tableRef.tableId) &&
        Objects.equals(this.tableName, tableRef.tableName)&&
        Objects.equals(this.additionalProperties, tableRef.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tableId, tableName, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TableRef
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TableRef.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : TableRef.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TableRef>() {
           ...
           public TableRef read(JsonReader in) throws IOException {
             ...
             TableRef instance = thisAdapter.fromJsonTree(jsonObj);
