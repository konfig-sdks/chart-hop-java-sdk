...
public class UpdateContent {
 ...
 public enum StatusEnum {
  ...
  public UpdateContent title(String title) {
  ...
  **/
  ...
  @ApiModelProperty(example = "Benefits Policies", value = "title of the content page")
  ...
  public UpdateContent parentContentId(String parentContentId) {
  ...
  **/
  ...
  public UpdateContent path(String path) {
  ...
  **/
  ...
  public UpdateContent blocks(List<ContentBlock> blocks) {
  ...
  public UpdateContent addBlocksItem(ContentBlock blocksItem) {
    if (this.blocks == null) {
  ...
  **/
  ...
  public UpdateContent imagePath(String imagePath) {
  ...
  **/
  ...
  public UpdateContent emoji(String emoji) {
  ...
  **/
  ...
  public UpdateContent coverImagePath(String coverImagePath) {
  ...
  **/
  ...
  public UpdateContent sensitive(SensitiveEnum sensitive) {
  ...
  **/
  ...
  public UpdateContent shareAccess(List<ShareAccess> shareAccess) {
  ...
  public UpdateContent addShareAccessItem(ShareAccess shareAccessItem) {
  ...
  **/
  ...
  public UpdateContent status(StatusEnum status) {
  ...
  **/
   ...
   * @return the UpdateContent instance itself
   */
  public UpdateContent putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateContent updateContent = (UpdateContent) o;
    return Objects.equals(this.title, updateContent.title) &&
        Objects.equals(this.parentContentId, updateContent.parentContentId) &&
        Objects.equals(this.path, updateContent.path) &&
        Objects.equals(this.blocks, updateContent.blocks) &&
        Objects.equals(this.imagePath, updateContent.imagePath) &&
        Objects.equals(this.emoji, updateContent.emoji) &&
        Objects.equals(this.coverImagePath, updateContent.coverImagePath) &&
        Objects.equals(this.sensitive, updateContent.sensitive) &&
        Objects.equals(this.shareAccess, updateContent.shareAccess) &&
        Objects.equals(this.status, updateContent.status)&&
        Objects.equals(this.additionalProperties, updateContent.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UpdateContent
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateContent.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateContent is not found in the empty JSON string", UpdateContent.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateContent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateContent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateContent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateContent.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateContent>() {
           @Override
           public void write(JsonWriter out, UpdateContent value) throws IOException {
           ...
           @Override
           public UpdateContent read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UpdateContent instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UpdateContent given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UpdateContent
  * @throws IOException if the JSON string is invalid with respect to UpdateContent
  */
  public static UpdateContent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateContent.class);
  }

 /**
  * Convert an instance of UpdateContent to an JSON string
  *
  * @return JSON string
  */
