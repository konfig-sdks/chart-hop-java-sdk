...
public class UpdateAssessment {
 ...
 public enum StatusEnum {
  ...
  public UpdateAssessment label(String label) {
  ...
  **/
  ...
  @ApiModelProperty(example = "Engineering Budget Q2 2019", value = "human-readable label of assessment")
  ...
  public UpdateAssessment slug(String slug) {
  ...
  **/
  ...
  public UpdateAssessment type(TypeEnum type) {
  ...
  **/
  ...
  public UpdateAssessment fields(Object fields) {
  ...
  **/
  ...
  public UpdateAssessment shareAccess(List<ShareAccess> shareAccess) {
  ...
  public UpdateAssessment addShareAccessItem(ShareAccess shareAccessItem) {
  ...
  **/
  ...
  public UpdateAssessment sensitive(SensitiveEnum sensitive) {
  ...
  **/
  ...
  public UpdateAssessment color(String color) {
  ...
  **/
  ...
  public UpdateAssessment startDate(LocalDate startDate) {
  ...
  **/
  ...
  public UpdateAssessment endDate(LocalDate endDate) {
  ...
  **/
  ...
  public UpdateAssessment status(StatusEnum status) {
  ...
  **/
  ...
  public UpdateAssessment doneAt(String doneAt) {
  ...
  **/
  ...
  public UpdateAssessment taskCount(Integer taskCount) {
  ...
  **/
  ...
  public UpdateAssessment taskDoneCount(Integer taskDoneCount) {
  ...
  **/
  ...
  public UpdateAssessment peopleIncludedCount(Integer peopleIncludedCount) {
  ...
  **/
  ...
  public UpdateAssessment query(String query) {
  ...
  **/
   ...
   * @return the UpdateAssessment instance itself
   */
  public UpdateAssessment putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateAssessment updateAssessment = (UpdateAssessment) o;
    return Objects.equals(this.label, updateAssessment.label) &&
        Objects.equals(this.slug, updateAssessment.slug) &&
        Objects.equals(this.type, updateAssessment.type) &&
        Objects.equals(this.fields, updateAssessment.fields) &&
        Objects.equals(this.shareAccess, updateAssessment.shareAccess) &&
        Objects.equals(this.sensitive, updateAssessment.sensitive) &&
        Objects.equals(this.color, updateAssessment.color) &&
        Objects.equals(this.startDate, updateAssessment.startDate) &&
        Objects.equals(this.endDate, updateAssessment.endDate) &&
        Objects.equals(this.status, updateAssessment.status) &&
        Objects.equals(this.doneAt, updateAssessment.doneAt) &&
        Objects.equals(this.taskCount, updateAssessment.taskCount) &&
        Objects.equals(this.taskDoneCount, updateAssessment.taskDoneCount) &&
        Objects.equals(this.peopleIncludedCount, updateAssessment.peopleIncludedCount) &&
        Objects.equals(this.query, updateAssessment.query)&&
        Objects.equals(this.additionalProperties, updateAssessment.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateAssessment {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UpdateAssessment
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateAssessment.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateAssessment is not found in the empty JSON string", UpdateAssessment.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateAssessment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateAssessment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateAssessment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateAssessment.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateAssessment>() {
           @Override
           public void write(JsonWriter out, UpdateAssessment value) throws IOException {
           ...
           @Override
           public UpdateAssessment read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UpdateAssessment instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UpdateAssessment given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UpdateAssessment
  * @throws IOException if the JSON string is invalid with respect to UpdateAssessment
  */
  public static UpdateAssessment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateAssessment.class);
  }

 /**
  * Convert an instance of UpdateAssessment to an JSON string
  *
  * @return JSON string
  */
