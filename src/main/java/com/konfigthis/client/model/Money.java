...
public class Money {
  ...
  **/
  ...
  public Money places(Double places) {
  ...
  public Money places(Integer places) {
    
    
    
    
    this.places = places.doubleValue();
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.amount, money.amount) &&
        ...
        Objects.equals(this.places, money.places)&&
        Objects.equals(this.additionalProperties, money.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(amount, currency, places, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Money
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Money.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
