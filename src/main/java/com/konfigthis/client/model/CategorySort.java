...
public class CategorySort {
  ...
  public CategorySort id(String id) {
  ...
  **/
  ...
  public CategorySort orgId(String orgId) {
  ...
  **/
  ...
  public CategorySort categoryIds(List<String> categoryIds) {
  ...
  public CategorySort addCategoryIdsItem(String categoryIdsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ordered list of category ids of an org")
  ...
  public CategorySort createId(String createId) {
  ...
  **/
  ...
  public CategorySort createAt(String createAt) {
  ...
  **/
  ...
  public CategorySort updateId(String updateId) {
  ...
  **/
  ...
  public CategorySort updateAt(String updateAt) {
  ...
  **/
  ...
  public CategorySort deleteId(String deleteId) {
  ...
  **/
  ...
  public CategorySort deleteAt(String deleteAt) {
  ...
  **/
   ...
   * @return the CategorySort instance itself
   */
  public CategorySort putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, categorySort.id) &&
        Objects.equals(this.orgId, categorySort.orgId) &&
        Objects.equals(this.categoryIds, categorySort.categoryIds) &&
        Objects.equals(this.createId, categorySort.createId) &&
        Objects.equals(this.createAt, categorySort.createAt) &&
        Objects.equals(this.updateId, categorySort.updateId) &&
        Objects.equals(this.updateAt, categorySort.updateAt) &&
        Objects.equals(this.deleteId, categorySort.deleteId) &&
        Objects.equals(this.deleteAt, categorySort.deleteAt)&&
        Objects.equals(this.additionalProperties, categorySort.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, orgId, categoryIds, createId, createAt, updateId, updateAt, deleteId, deleteAt, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CategorySort {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CategorySort
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CategorySort.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CategorySort is not found in the empty JSON string", CategorySort.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CategorySort.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CategorySort.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CategorySort' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CategorySort> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CategorySort.class));

       return (TypeAdapter<T>) new TypeAdapter<CategorySort>() {
           @Override
           public void write(JsonWriter out, CategorySort value) throws IOException {
           ...
           @Override
           public CategorySort read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CategorySort instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CategorySort given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CategorySort
  * @throws IOException if the JSON string is invalid with respect to CategorySort
  */
  public static CategorySort fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CategorySort.class);
  }

 /**
  * Convert an instance of CategorySort to an JSON string
  *
  * @return JSON string
  */
