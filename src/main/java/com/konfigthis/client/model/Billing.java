...
public class Billing {
  ...
  public Billing checkout(Checkout checkout) {
  ...
  **/
  ...
  public Billing invoices(List<Invoice> invoices) {
  ...
  public Billing addInvoicesItem(Invoice invoicesItem) {
  ...
  **/
  ...
  public Billing paymentInfo(PaymentInfo paymentInfo) {
  ...
  **/
   ...
   * @return the Billing instance itself
   */
  public Billing putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.checkout, billing.checkout) &&
        Objects.equals(this.customer, billing.customer) &&
        Objects.equals(this.invoices, billing.invoices) &&
        Objects.equals(this.paymentInfo, billing.paymentInfo) &&
        Objects.equals(this.plan, billing.plan) &&
        Objects.equals(this.org, billing.org)&&
        Objects.equals(this.additionalProperties, billing.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(checkout, customer, invoices, paymentInfo, plan, org, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Billing.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("checkout") != null && !jsonObj.get("checkout").isJsonNull()) {
        Checkout.validateJsonObject(jsonObj.getAsJsonObject("checkout"));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Billing>() {
           ...
           public Billing read(JsonReader in) throws IOException {
             ...
             Billing instance = thisAdapter.fromJsonTree(jsonObj);
