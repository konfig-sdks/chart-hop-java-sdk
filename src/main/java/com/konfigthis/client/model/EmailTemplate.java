...
public class EmailTemplate {
 ...
 public enum CategoryEnum {
  ...
  public EmailTemplate id(String id) {
  ...
  **/
  ...
  public EmailTemplate category(CategoryEnum category) {
  ...
  **/
   ...
   * @return the EmailTemplate instance itself
   */
  public EmailTemplate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, emailTemplate.id) &&
        ...
        Objects.equals(this.category, emailTemplate.category)&&
        Objects.equals(this.additionalProperties, emailTemplate.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, category, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmailTemplate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : EmailTemplate.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EmailTemplate>() {
           ...
           public EmailTemplate read(JsonReader in) throws IOException {
             ...
             EmailTemplate instance = thisAdapter.fromJsonTree(jsonObj);
