...
public class UpdateTaskConfig {
 ...
 public enum PastDueActionEnum {
  ...
  public UpdateTaskConfig() {
  }

  public UpdateTaskConfig description(String description) {
  ...
  **/
  ...
  public UpdateTaskConfig type(TypeEnum type) {
  ...
  **/
  ...
  public UpdateTaskConfig dueDate(DueDate dueDate) {
  ...
  **/
  ...
  public UpdateTaskConfig pastDueAction(PastDueActionEnum pastDueAction) {
  ...
  **/
  ...
  public UpdateTaskConfig isSkippable(Boolean isSkippable) {
  ...
  **/
  ...
  public UpdateTaskConfig label(String label) {
  ...
  **/
  ...
  public UpdateTaskConfig deleteId(String deleteId) {
  ...
  **/
  ...
  public UpdateTaskConfig deleteAt(String deleteAt) {
  ...
  **/
   ...
   * @return the UpdateTaskConfig instance itself
   */
  public UpdateTaskConfig putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateTaskConfig updateTaskConfig = (UpdateTaskConfig) o;
    return Objects.equals(this.description, updateTaskConfig.description) &&
        Objects.equals(this.type, updateTaskConfig.type) &&
        Objects.equals(this.dueDate, updateTaskConfig.dueDate) &&
        Objects.equals(this.pastDueAction, updateTaskConfig.pastDueAction) &&
        Objects.equals(this.isSkippable, updateTaskConfig.isSkippable) &&
        Objects.equals(this.label, updateTaskConfig.label) &&
        Objects.equals(this.deleteId, updateTaskConfig.deleteId) &&
        Objects.equals(this.deleteAt, updateTaskConfig.deleteAt)&&
        Objects.equals(this.additionalProperties, updateTaskConfig.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, type, dueDate, pastDueAction, isSkippable, label, deleteId, deleteAt, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateTaskConfig {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UpdateTaskConfig
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateTaskConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateTaskConfig is not found in the empty JSON string", UpdateTaskConfig.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateTaskConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateTaskConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateTaskConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateTaskConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateTaskConfig>() {
           @Override
           public void write(JsonWriter out, UpdateTaskConfig value) throws IOException {
           ...
           @Override
           public UpdateTaskConfig read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UpdateTaskConfig instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UpdateTaskConfig given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UpdateTaskConfig
  * @throws IOException if the JSON string is invalid with respect to UpdateTaskConfig
  */
  public static UpdateTaskConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateTaskConfig.class);
  }

 /**
  * Convert an instance of UpdateTaskConfig to an JSON string
  *
  * @return JSON string
  */
